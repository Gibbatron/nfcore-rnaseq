...
mv Homo_sapiens.GRCh38.dna_sm.primary_assembly.fa.gz resources/Homo_sapiens.GRCh38.dna_sm.primary_assembly.fa.gz

#download the human GRCh38 reference gene information file
wget https://ftp.ensembl.org/pub/release-110/gtf/homo_sapiens/Homo_sapiens.GRCh38.110.gtf.gz 
gunzip Homo_sapiens.GRCh38.110.gtf.gz
mv Homo_sapiens.GRCh38.110.gtf.gz resources/Homo_sapiens.GRCh38.110.gtf.gz
#############
